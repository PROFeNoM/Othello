...
#COL = [chr(i) for i in range(ord("A"), ord("A")+SIZE)]
...
#COL_NUM = {c : i for i,c in enumerate([chr(i) for i in range(ord("A"), ord("A")+SIZE)])}

# Return a str correspong to a given int column
#NUM_COL = {i : c for i,c in enumerate([chr(i) for i in range(ord("A"), ord("A")+SIZE)])}
...
#CORNER = ["A1", chr(ord("A")+SIZE-1)+"1", "A"+str(SIZE), chr(ord("A")+SIZE-1)+str(SIZE)]

# Position of X squares
#X_SQUARES = ["B2", chr(ord("A")+SIZE-2)+"2", "B"+str(SIZE-1), chr(ord("A")+SIZE-2)+str(SIZE-1)]

# Position of C squares
#C_SQUARES = [["A2", "B1"], [chr(ord("A")+SIZE-2)+"1", chr(ord("A")+SIZE-1)+"2"], ["A"+str(SIZE-1), "B"+str(SIZE)], [chr(ord("A")+SIZE-2)+str(SIZE), chr(ord("A")+SIZE-1)+str(SIZE-1)]]
# -- AI UTILITY ENDS --
